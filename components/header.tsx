...
export const Header = () => {
  ...
  return (
    <header className="flex flex-col justify-between items-center z-1000 h-(--header-height) sticky top-0 after:block after:content-[''] after:h-px after:w-full after:bg-(--color-border)">
